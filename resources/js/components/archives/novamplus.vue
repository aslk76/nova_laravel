...
<v-app style="background: 0!important; padding-left: 10px; padding-right: 10px;">
    <div style="background: rgba(40, 41, 43, 0.9);border-radius: 5px;">
        ...
        >
        <template v-slot:item.boost_pot="{ item }">
             {{item.boost_pot.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}}
        </template>
        ...
        <v-dialog v-model="dialog">
            <v-card class="mx-auto">
                ...
                <template v-slot:item.healer_name="props">
                    <v-edit-dialog
                        :return-value.sync="props.item.healer_name"
                        large
                        persistent
                    >
                        <div>{{ props.item.healer_name }}</div>
                        <template v-slot:input>
                            <div class="mt-4 title">
                                Update Healer Name
                            </div>
                            <v-text-field
                                v-model="props.item.healer_name"
                                label="Edit"
                                single-line
                                counter
                                autofocus
                ...
                <template v-slot:item.healer_cut="props">
                    <v-edit-dialog
                        :return-value.sync="props.item.healer_cut"
                        large
                        persistent
                    >
                        <div>{{ props.item.healer_cut }}</div>
                        <template v-slot:input>
                            <div class="mt-4 title">
                                Update Healer Cut
                            </div>
                            <v-text-field
                                v-model="props.item.healer_cut"
                                label="Edit"
                                single-line
                                counter
                                autofocus
                ...
                <template v-slot:item.dps1_name="props">
                    <v-edit-dialog
                        :return-value.sync="props.item.dps1_name"
                        large
                        persistent
                    >
                        <div>{{ props.item.dps1_name }}</div>
                        <template v-slot:input>
                            <div class="mt-4 title">
                                Update DPS1 Name
                            </div>
                            <v-text-field
                                v-model="props.item.dps1_name"
                                label="Edit"
                                single-line
                                counter
                                autofocus
                ...
                <template v-slot:item.dps1_cut="props">
                    <v-edit-dialog
                        :return-value.sync="props.item.dps1_cut"
                        large
                        persistent
                    >
                        <div>{{ props.item.dps1_cut }}</div>
                        <template v-slot:input>
                            <div class="mt-4 title">
                                Update DPS1 Cut
                            </div>
                            <v-text-field
                                v-model="props.item.dps1_cut"
                                label="Edit"
                                single-line
                                counter
                                autofocus
                ...
                <template v-slot:item.dps2_name="props">
                    <v-edit-dialog
                        :return-value.sync="props.item.dps2_name"
                        large
                        persistent
                    >
                        <div>{{ props.item.dps2_name }}</div>
                        <template v-slot:input>
                            <div class="mt-4 title">
                                Update DPS2 Name
                            </div>
                            <v-text-field
                                v-model="props.item.dps2_name"
                                label="Edit"
                                single-line
                                counter
                                autofocus
                ...
                <template v-slot:item.dps2_cut="props">
                    <v-edit-dialog
                        :return-value.sync="props.item.dps2_cut"
                        large
                        persistent
                    >
                        <div>{{ props.item.dps2_cut }}</div>
                        <template v-slot:input>
                            <div class="mt-4 title">
                                Update DPS2 Cut
                            </div>
                            <v-text-field
                                v-model="props.item.dps2_cut"
                                label="Edit"
                                single-line
                                counter
                                autofocus
...
<script>
  export default {
    ...
    methods: {
        getItems() {
            axios
            .get('/getAllArchivesMplus', { transformResponse: [data => data] })
            .then ((response) => {
        ...
        showAllianceRuns() {
            axios
            .get('/getAllAllianceArchivesMplus', { transformResponse: [data => data] })
            .then ((response) => {
                let parsed = JSON.parse(response.data.replace(/"boost_id":(\d+),/g, '"boost_id":"$1",'))
                console.log(parsed)
                this.items = parsed
        ...
        showHordeRuns() {
            axios
            .get('/getAllHordeArchivesMplus', { transformResponse: [data => data] })
            .then ((response) => {
                let parsed = JSON.parse(response.data.replace(/"boost_id":(\d+),/g, '"boost_id":"$1",'))
                console.log(parsed)
                this.items = parsed
