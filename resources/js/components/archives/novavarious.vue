  ...
  export default {
    ...
    methods: {
        ...
        onCheckboxClicked(id, status) {
            axios
            .post('/changeCheckboxArchivesVarious', {
                id: id,
                status: status
            })
            .then ((response) => {
        ...
        showAllianceRuns() {
            axios
            .get('/getAllAllianceArchivesVarious')
            .then ((response) => {
                this.items = response.data
                console.log(response.data)
            })
        ...
        showHordeRuns() {
            axios
            .get('/getAllHordeArchivesVarious')
            .then ((response) => {
                this.items = response.data
                console.log(response.data)
            })
        ...
        showDialog(row) {
            axios
            .get('/getSpecificArchivesVarious/' + row.id)
            .then ((response) => {
