...
<script>
  export default {
    ...
    methods: {
        getItems() {
            axios
            .get('/getAllArchivesVarious', { transformResponse: [data => data] })
            .then ((response) => {
        ...
        showAllianceRuns() {
            axios
            .get('/getAllAllianceArchivesVarious', { transformResponse: [data => data] })
            .then ((response) => {
                let parsed = JSON.parse(response.data.replace(/"boost_id":(\d+),/g, '"boost_id":"$1",'))
                console.log(parsed)
                this.items = parsed
        ...
        showHordeRuns() {
            axios
            .get('/getAllHordeArchivesVarious', { transformResponse: [data => data] })
            .then ((response) => {
                let parsed = JSON.parse(response.data.replace(/"boost_id":(\d+),/g, '"boost_id":"$1",'))
                console.log(parsed)
                this.items = parsed
